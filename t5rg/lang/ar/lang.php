...
<br>
<br>ملاحظة: لا يمكن بناء الخزنة في القرية التي يتم بناء معجزة العالم بها. 
<br>
<br>الخزنة مستوى 1 تمكن أي لاعب في السيرفر من معرفة الأماكن التي توجد بها التحف . والخزنة مستوى 10 تمكن اللاعب من الإستيلاء على التحف.");
  ...
  define("troop_49", "");
  define("troop_50", "");
  define("troop_51", "محارب المغول");
  define("troop_52", "مقاتل المغول");
  define("troop_53", "المهاجم الشرس");
  define("troop_54", "المستطلع");
  define("troop_55", "الفارس المغولي ");
  ...
  define("troop_desc_51", "محارب المغول  هو نوع من مشاة قبيلة المغول. حصل على التدريب في مجالات عديدة، وهو مفيد في الهجوم والدفاع أيضاً ولكنه في أحسن الحالات لن يصل لقوة الواحدات المتخصصة.");
  define("troop_desc_52", "محارب المغول هو أقوى المشاة لقبيلة المغول. قوي في الدفاع متواضع في الهجوم ، وهو أبطأ وأكثر كلفة من الوحدات الأخرى.");
  define("troop_desc_53", "المهاجم الشرس هو المهاجم الأقوى في فيلق المشاة لقبيلة المغول. سريع وقوي فهو يبث الرعب في قلب كل مدافع. هذه القوة لها ثمنها وهو التدريب الطويل و المكلف.");
  define("troop_desc_54", "المستطلع هو الجاسوس فى الوحدات التابعه لقبيلة المغول و هو استثناءى بالسرعة و قادر على التجسس على قوات العدو سرا و كذلك الموارد او الدفاعات اذا لم يكن هناك جواسيس فى قرية العدو فسوف لن يعلم بزيارتهم لهم الا ان قدرتة الهجومية معدومة ");
  define("troop_desc_55", "الفارس المغولي هو الفارس المحارب الذي يجعل قوى اعدائه تنكمش في خوف. وهو ايضا مدافع ممتاز ضد فرسان العدو. ولكن التدريب وتكاليف الصيانة مرتفعة.");
  ...
  define("payments_cashu_description", "الدفع عبر CashU سهل و سريع ماعليك سوا تعبئة بيانات حسابك في كاش يو والدفع فورأ 
<br><a href='http://www.youtube.com/watch?v=v1Z-eX1AAIw'>فيديو يوضح طريقة الشراء لمن لا يعرف </a>
");
...
$domain = WebHelper::getdomain();
  define("register_player_txt_regmail_body", "مرحباً %s ,<p>

الشكر الجزيل لتسجيلك في لعبة حرب التتار.<br>
أهلاً بك في عالم الإثارة والمتعة على الانترنت
<p>
----------------------------<br>
بيانات الدخول الخاصة بك:<p>

اسم المستخدم (العضوية):  %s<br/>\r\nكلمة السر: %s<br/>\r\n----------------------------<br/>\r\n<br/>\r\n
من أجل إكمال عملية التسجيل ولتستطيع بدء<br>
اللعب، قم رجاء بالضغط على الرابط التالي:<br>
<br/>\r\n<a href=\"%s\">%s</a><br>
<br/>\r\n----------------------------<br/>
<br>
نرجو لك الكثير من المتعة والإثارة معنا<br>
<br>
فريق حرب التتار
");
...
//file
  ...
  define("LANGUI_MSG_T17", "لإرسال رسالة لأعضاء تحالفك أكتب في أسم المستلم <b>[tatar]</b><br/>أيضا يجب أن تملك هذه السماحية");
  ...
  define('LANGUI_INVITE_T5', 'عندما يصل اللاعب الذي أرسلت له دعوة إلى لعبة حرب التتار، في بناء <b>2</b> قرى، تحصل على ذهب مجاني بمقدار <img src="assets/x.gif" class="gold" alt="ذهب" title="ذهب" /> <b>100</b> وهذه تضاف الى رصيدك الخاص');
...
define("LANGUI_REG_T19", "تم التسجيل بنجاح . وتم تفعيل العضوية تلقائيا. <br><br>\r\nسيتم إرسال البريد إلى العنوان التالي");
