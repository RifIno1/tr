...
class ProfileModel extends ModelBase
{
    ...
    public function getTop1Deffer( )
    {
        $playerId = intval( $this->provider->fetchScalar( "SELECT  `id`,`defense_points`,`name` FROM  `p_players` ORDER BY  `defense_points` DESC LIMIT 1" ) );
        return $this->getPlayerDataById( $playerId );
    }
    public function getTop1Pop( )
    {
    ...
    public function getTop1Popl( )
    {
        $playerId = intval( $this->provider->fetchScalar( "SELECT  `id`,`total_people_count`,`name` FROM  `p_players` WHERE name != 'التتار' ORDER BY  `total_people_count` DESC LIMIT 2" ) );
        return $this->getPlayerDataById( $playerId );
    }

    public function getTop1Popll( )
    {
        $playerId = intval( $this->provider->fetchScalar( "SELECT  `id`,`total_people_count`,`name` FROM  `p_players` WHERE name != 'التتار' ORDER BY  `total_people_count` DESC LIMIT 3" ) );
        return $this->getPlayerDataById( $playerId );
    }
