...
{ 
   public function GetPlayerDataByName ( $playerName ) 
	...
	public function UpdateVillageData ( $id, $rel_x, $rel_y, $tribe_id, $player_id, $alliance_id, $player_name, $village_name, $alliance_name, $is_capital, $is_special_village, $is_oasis, $people_count, $crop_consumption, $resources, $cp, $buildings, $troops_num, $village_oases_id, $vid )
	{
	    ...
	    $this->provider->executeQuery( "UPDATE p_villages v SET v.id=%s, v.rel_x='%s', v.rel_y='%s', v.tribe_id=%s, v.player_id=%s, v.alliance_id=%s, v.player_name='%s', v.village_name='%s', v.alliance_name='%s', v.is_capital=%s, v.is_special_village=%s, v.is_oasis=%s, v.people_count=%s, v.crop_consumption='%s', v.resources='%s', v.cp='%s', v.buildings='%s', v.troops_num='%s', v.village_oases_id='%s', v.last_update_date=NOW() WHERE  v.id=%s", array(
		    $id, $rel_x, $rel_y, $tribe_id, $player_id, $alliance_id, $player_name, $village_name, $alliance_name, $is_capital, $is_special_village, $is_oasis, $people_count, $crop_consumption, $resources, $cp, $buildings, $troops_num, $village_oases_id, $vid
		) );
    }
