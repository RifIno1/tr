    ...
    for (cnt = 0; cnt < e; cnt++) {
        if (document.farm.elements[cnt].name == "list[]") {
            if (document.farm.elements[cnt].checked) {
                ...
                let troops = farmingdata[4].split(',');
                post_to_url("v2v.php?t=2", (function() {
                  let data = {
                      'id': farmingdata[0],
                      'c': '4',
                      'key': farmingdata[5],
                  ...
                  troops.forEach(troop => {
                      let [troopType, troopCount] = troop.split(' ');
                      data['t[' + troopType + ']'] = troopCount;
                  });
